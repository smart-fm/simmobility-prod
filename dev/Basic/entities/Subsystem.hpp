...
private:
	...
	std::vector<sim_mob::Signal*> Slaves;
//	sim_mob::Signal* S1;
//	sim_mob::Signal* S2;
...
//	std::vector<std::vector<double> > currSplitPlan_S;
	std::map<sim_mob::Signal*,std::vector<double> > currSplitPlan_S;
...
//	int Offset_S1;
//	int Offset_S2;
	std::map<sim_mob::Signal*,int > Offset_S;
