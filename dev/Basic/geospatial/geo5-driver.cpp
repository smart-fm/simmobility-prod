...
main1 ()
{
	std::cout << "Entering Main1()" << std::endl;
  try
  {
    ...
    ::geo::SegmentType_t_pimpl SegmentType_t_p;
    ...
    ::geo::LaneType_t_pimpl LaneType_t_p;
    ...
    Point2D_t_p.parsers (positive_integer_p,
                         positive_integer_p);
    ...
    RoadItems_t_p.parsers (BusStops_p,
                           ERP_Gantries_p,
                           Crossings_p,
                           RoadBumps_p);

    BusStops_p.parsers (BusStop_t_p);
    ...
    ERP_Gantries_p.parsers (ERP_Gantry_t_p);

    ERP_Gantry_t_p.parsers (Point2D_t_p,
                            Point2D_t_p,
                            string_p);

    Crossings_p.parsers (crossing_t_p);
    ...
    RoadBumps_p.parsers (RoadBump_t_p);
