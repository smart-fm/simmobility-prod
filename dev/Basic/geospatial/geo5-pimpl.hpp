...
#ifndef GEO5_PIMPL_HPP
#define GEO5_PIMPL_HPP
...
namespace geo
{
  ...
  class fwdBckSegments_t_pimpl: public virtual fwdBckSegments_t_pskel
  {
    ...
    private:
    std::vector<sim_mob::RoadSegment*> rs;
  };
...
//    post_Segments ();
    std::pair<std::vector<sim_mob::RoadSegment*>,std::vector<sim_mob::RoadSegment*> > post_Segments ();
    private:
    std::vector<sim_mob::RoadSegment*> fwd,bkd;
