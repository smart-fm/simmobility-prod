...
namespace geo
{
  ...
  xPos_parser (::xml_schema::positive_integer_pskel& p)
  {
    this->xPos_parser_ = &p;
  }

  void Point2D_t_pskel::
  yPos_parser (::xml_schema::positive_integer_pskel& p)
  {
    this->yPos_parser_ = &p;
  }
  ...
  void lane_t_pskel::
  laneType_parser (::geo::LaneType_t_pskel& p)
  {
    this->laneType_parser_ = &p;
  }

  void lane_t_pskel::
  Width_parser (::xml_schema::positive_integer_pskel& p)
  {
           ...
           ::xml_schema::boolean_pskel& is_u_turn_allowed)
  {
    ...
    this->laneType_parser_ = &laneType;
  ...
  void segment_t_pskel::
  segmentType_parser (::geo::SegmentType_t_pskel& p)
  {
    this->segmentType_parser_ = &p;
  }

  void segment_t_pskel::
  parentLink_parser (::xml_schema::string_pskel& p)
  {
    this->parentLink_parser_ = &p;
  }
  ...
  void segment_t_pskel::
  LanesLeftOfDivider_parser (::xml_schema::positive_integer_pskel& p)
  {
    this->LanesLeftOfDivider_parser_ = &p;
  }
  ...
  : segmentID_parser_ (0),
    ...
    parentLink_parser_ (0),
    StartingNode_parser_ (0),
    EndingNode_parser_ (0),
    Maxspeed_parser_ (0),
    LanesLeftOfDivider_parser_ (0),
    Lanes_parser_ (0),
    KurbLine_parser_ (0)
  {
  }
  ...
  void offset_t_pskel::
  offset_value_parser (::xml_schema::positive_integer_pskel& p)
  {
  ...
  void ChunkLength_t_pskel::
  chunklength_value_parser (::xml_schema::positive_integer_pskel& p)
  {
  ...
  void EntranceAngle_t_pskel::
  entranceAngle_value_parser (::xml_schema::positive_integer_pskel& p)
  {
  ...
  void UniNode_t_pskel::
  Conectors_parser (::geo::connectors_t_pskel& p)
  {
    this->Conectors_parser_ = &p;
  }
           ...
           ::geo::connectors_t_pskel& Conectors)
  {
    ...
    this->location_parser_ = &location;
    this->Conectors_parser_ = &Conectors;
  }
  ...
  BusStops_parser (::geo::BusStops_pskel& p)
  {
    this->BusStops_parser_ = &p;
  }

  void RoadItems_t_pskel::
  ERP_Gantries_parser (::geo::ERP_Gantries_pskel& p)
  {
    this->ERP_Gantries_parser_ = &p;
  }

  void RoadItems_t_pskel::
  Crossings_parser (::geo::Crossings_pskel& p)
  {
    this->Crossings_parser_ = &p;
  }

  void RoadItems_t_pskel::
  RoadBumps_parser (::geo::RoadBumps_pskel& p)
  {
    this->RoadBumps_parser_ = &p;
  }
  ...
  {
    this->BusStops_parser_ = &BusStops;
    this->ERP_Gantries_parser_ = &ERP_Gantries;
    this->Crossings_parser_ = &Crossings;
    this->RoadBumps_parser_ = &RoadBumps;
  }

  RoadItems_t_pskel::
  RoadItems_t_pskel ()
  : BusStops_parser_ (0),
    ERP_Gantries_parser_ (0),
    Crossings_parser_ (0),
    RoadBumps_parser_ (0)
  {
  }
  ...
  void GeoSpatial_t_pskel::
  RoadItems_parser (::geo::RoadItems_t_pskel& p)
  {
    this->RoadItems_parser_ = &p;
  }
           ...
           ::geo::RoadItems_t_pskel& RoadItems)
  {
    ...
    this->RoadItems_parser_ = &RoadItems;
  }
...
namespace geo
{
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    {
      if (this->xPos_parser_)
        this->xPos (this->xPos_parser_->post_positive_integer ());
    ...
    {
      if (this->yPos_parser_)
        this->yPos (this->yPos_parser_->post_positive_integer ());
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "location" && ns.empty ())
    {
      if (this->location_parser_)
      {
        this->location_parser_->post_Point2D_t ();
        this->location ();
      }
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "PolyPoint" && ns.empty ())
    {
      if (this->PolyPoint_parser_)
      {
        this->PolyPoint_parser_->post_PolyPoint_t ();
        this->PolyPoint ();
      }
                       ...
                       const ::xml_schema::ro_string* t)
  {
    ...
    if (n == "laneType" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->laneType_parser_;

      if (this->laneType_parser_)
        this->laneType_parser_->pre ();
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "laneType" && ns.empty ())
    {
      if (this->laneType_parser_)
      {
        this->laneType_parser_->post_LaneType_t ();
        this->laneType ();
      }
    ...
    {
      if (this->Width_parser_)
        this->Width (this->Width_parser_->post_positive_integer ());
                       ...
                       const ::xml_schema::ro_string* t)
  {
    ...
    if (n == "parentLink" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->parentLink_parser_;

      if (this->parentLink_parser_)
        this->parentLink_parser_->pre ();
    ...
    if (n == "LanesLeftOfDivider" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->LanesLeftOfDivider_parser_;

      if (this->LanesLeftOfDivider_parser_)
        this->LanesLeftOfDivider_parser_->pre ();
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    {
      if (this->segmentType_parser_)
        this->segmentType (this->segmentType_parser_->post_SegmentType_t ());
    ...
    {
      if (this->parentLink_parser_)
        this->parentLink (this->parentLink_parser_->post_string ());
    ...
    {
      if (this->LanesLeftOfDivider_parser_)
        this->LanesLeftOfDivider (this->LanesLeftOfDivider_parser_->post_positive_integer ());
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    {
      if (this->offset_value_parser_)
        this->offset_value (this->offset_value_parser_->post_positive_integer ());
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    {
      if (this->chunklength_value_parser_)
        this->chunklength_value (this->chunklength_value_parser_->post_positive_integer ());
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    {
      if (this->entranceAngle_value_parser_)
        this->entranceAngle_value (this->entranceAngle_value_parser_->post_positive_integer ());
                       ...
                       const ::xml_schema::ro_string* t)
  {
    ...
    if (n == "Conectors" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->Conectors_parser_;

      if (this->Conectors_parser_)
        this->Conectors_parser_->pre ();
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "Conectors" && ns.empty ())
    {
      if (this->Conectors_parser_)
      {
        this->Conectors_parser_->post_connectors_t ();
        this->Conectors ();
      }
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "start" && ns.empty ())
    {
      if (this->start_parser_)
      {
        this->start_parser_->post_Point2D_t ();
        this->start ();
      }
    ...
    if (n == "end" && ns.empty ())
    {
      if (this->end_parser_)
      {
        this->end_parser_->post_Point2D_t ();
        this->end ();
      }
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "First" && ns.empty ())
    {
      if (this->First_parser_)
      {
        this->First_parser_->post_Point2D_t ();
        this->First ();
      }
    ...
    if (n == "Second" && ns.empty ())
    {
      if (this->Second_parser_)
      {
        this->Second_parser_->post_Point2D_t ();
        this->Second ();
      }
                       ...
                       const ::xml_schema::ro_string* t)
  {
    ...
    if (n == "BusStops" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->BusStops_parser_;

      if (this->BusStops_parser_)
        this->BusStops_parser_->pre ();

      return true;
    }

    if (n == "ERP_Gantries" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->ERP_Gantries_parser_;

      if (this->ERP_Gantries_parser_)
        this->ERP_Gantries_parser_->pre ();

      return true;
    }

    if (n == "Crossings" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->Crossings_parser_;

      if (this->Crossings_parser_)
        this->Crossings_parser_->pre ();

      return true;
    }

    if (n == "RoadBumps" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->RoadBumps_parser_;

      if (this->RoadBumps_parser_)
        this->RoadBumps_parser_->pre ();
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "BusStops" && ns.empty ())
    {
      if (this->BusStops_parser_)
      {
        this->BusStops_parser_->post_BusStops ();
        this->BusStops ();
      }
    ...
    if (n == "ERP_Gantries" && ns.empty ())
    {
      if (this->ERP_Gantries_parser_)
      {
        this->ERP_Gantries_parser_->post_ERP_Gantries ();
        this->ERP_Gantries ();
      }
    ...
    if (n == "Crossings" && ns.empty ())
    {
      if (this->Crossings_parser_)
      {
        this->Crossings_parser_->post_Crossings ();
        this->Crossings ();
      }
    ...
    if (n == "RoadBumps" && ns.empty ())
    {
      if (this->RoadBumps_parser_)
      {
        this->RoadBumps_parser_->post_RoadBumps ();
        this->RoadBumps ();
      }
                       ...
                       const ::xml_schema::ro_string* t)
  {
    ...
    if (n == "RoadItems" && ns.empty ())
    {
      this->::xml_schema::complex_content::context_.top ().parser_ = this->RoadItems_parser_;

      if (this->RoadItems_parser_)
        this->RoadItems_parser_->pre ();
                     ...
                     const ::xml_schema::ro_string& n)
  {
    ...
    if (n == "RoadItems" && ns.empty ())
    {
      if (this->RoadItems_parser_)
      {
        this->RoadItems_parser_->post_RoadItems_t ();
        this->RoadItems ();
      }
