...
namespace sim_mob
{
    namespace long_term
    {
        ...
        private:
             ...
             */
            void fromRow(db::Row& result, DevelopmentPlan& outObj);
             ...
             */
            void toRow(DevelopmentPlan& data, db::Parameters& outParams, bool update);
        ...
        public:
            ...
            */
            ...
            void insertDevelopmentPlan(DevelopmentPlan& devPlan,std::string schema);
        };
    }
}
