...
JobDao::JobDao(DB_Connection& connection): SqlAbstractDao<Job>(connection, DB_TABLE_JOB, DB_INSERT_JOB, DB_UPDATE_JOB, DB_DELETE_JOB, DB_GETALL_JOB, DB_GETBYID_JOB)
{}
