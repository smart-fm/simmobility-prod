...
SlaParcelDao::SlaParcelDao(DB_Connection& connection): SqlAbstractDao<SlaParcel>(connection, DB_TABLE_SLA_PARCEL,EMPTY_STR,EMPTY_STR,
		                   EMPTY_STR, DB_GETALL_SLA_PARCELS, EMPTY_STR) {}
