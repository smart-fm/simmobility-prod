...
TotalBuildingSpaceDao::TotalBuildingSpaceDao(DB_Connection& connection): SqlAbstractDao<TotalBuildingSpace>( connection, EMPTY_STR, EMPTY_STR, EMPTY_STR,EMPTY_STR,DB_GETALL_TOTAL_BUILDING_SPACE, EMPTY_STR ) {}
