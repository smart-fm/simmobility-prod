...
namespace sim_mob
{
	namespace long_term
	{
		...
		void Hits2008ScreeningProb::getProbabilities(std::vector<double> &screeningProbabilities ) const
		{
			screeningProbabilities.push_back(p1);
			screeningProbabilities.push_back(p2);
			screeningProbabilities.push_back(p3);
			screeningProbabilities.push_back(p4);
			screeningProbabilities.push_back(p5);
			screeningProbabilities.push_back(p6);
			screeningProbabilities.push_back(p7);
			screeningProbabilities.push_back(p8);
			screeningProbabilities.push_back(p9);
			screeningProbabilities.push_back(p10);
			screeningProbabilities.push_back(p11);
			screeningProbabilities.push_back(p12);
			screeningProbabilities.push_back(p13);
			screeningProbabilities.push_back(p14);
			screeningProbabilities.push_back(p15);
			screeningProbabilities.push_back(p16);
			screeningProbabilities.push_back(p17);
			screeningProbabilities.push_back(p18);
			screeningProbabilities.push_back(p19);
			screeningProbabilities.push_back(p20);
			screeningProbabilities.push_back(p21);
			screeningProbabilities.push_back(p22);
			screeningProbabilities.push_back(p23);
			screeningProbabilities.push_back(p24);
			screeningProbabilities.push_back(p25);
			screeningProbabilities.push_back(p26);
			screeningProbabilities.push_back(p27);
			screeningProbabilities.push_back(p28);
			screeningProbabilities.push_back(p29);
			screeningProbabilities.push_back(p30);
			screeningProbabilities.push_back(p31);
			screeningProbabilities.push_back(p32);
			screeningProbabilities.push_back(p33);
			screeningProbabilities.push_back(p34);
			screeningProbabilities.push_back(p35);
			screeningProbabilities.push_back(p36);
			screeningProbabilities.push_back(p37);
			screeningProbabilities.push_back(p38);
			screeningProbabilities.push_back(p39);
			screeningProbabilities.push_back(p40);
			screeningProbabilities.push_back(p41);
			screeningProbabilities.push_back(p42);
			screeningProbabilities.push_back(p43);
			screeningProbabilities.push_back(p44);
			screeningProbabilities.push_back(p45);
			screeningProbabilities.push_back(p46);
			screeningProbabilities.push_back(p47);
			screeningProbabilities.push_back(p48);
			screeningProbabilities.push_back(p49);
			screeningProbabilities.push_back(p50);
			screeningProbabilities.push_back(p51);
			screeningProbabilities.push_back(p52);
			screeningProbabilities.push_back(p53);
			screeningProbabilities.push_back(p54);
			screeningProbabilities.push_back(p55);
			screeningProbabilities.push_back(p56);
			screeningProbabilities.push_back(p57);
			screeningProbabilities.push_back(p58);
			screeningProbabilities.push_back(p59);
			screeningProbabilities.push_back(p60);
			screeningProbabilities.push_back(p61);
			screeningProbabilities.push_back(p62);
			screeningProbabilities.push_back(p63);
			screeningProbabilities.push_back(p64);
			screeningProbabilities.push_back(p65);
			screeningProbabilities.push_back(p66);
			screeningProbabilities.push_back(p67);
			screeningProbabilities.push_back(p68);
			screeningProbabilities.push_back(p69);
			screeningProbabilities.push_back(p70);
			screeningProbabilities.push_back(p71);
			screeningProbabilities.push_back(p72);
			screeningProbabilities.push_back(p73);
			screeningProbabilities.push_back(p74);
			screeningProbabilities.push_back(p75);
			screeningProbabilities.push_back(p76);
			screeningProbabilities.push_back(p77);
			screeningProbabilities.push_back(p78);
			screeningProbabilities.push_back(p79);
			screeningProbabilities.push_back(p80);
			screeningProbabilities.push_back(p81);
			screeningProbabilities.push_back(p82);
			screeningProbabilities.push_back(p83);
			screeningProbabilities.push_back(p84);
			screeningProbabilities.push_back(p85);
			screeningProbabilities.push_back(p86);
			screeningProbabilities.push_back(p87);
			screeningProbabilities.push_back(p88);
			screeningProbabilities.push_back(p89);
			screeningProbabilities.push_back(p90);
			screeningProbabilities.push_back(p91);
			screeningProbabilities.push_back(p92);
			screeningProbabilities.push_back(p93);
			screeningProbabilities.push_back(p94);
			screeningProbabilities.push_back(p95);
			screeningProbabilities.push_back(p96);
			screeningProbabilities.push_back(p97);
			screeningProbabilities.push_back(p98);
			screeningProbabilities.push_back(p99);
			screeningProbabilities.push_back(p100);
			screeningProbabilities.push_back(p101);
			screeningProbabilities.push_back(p102);
			screeningProbabilities.push_back(p103);
			screeningProbabilities.push_back(p104);
			screeningProbabilities.push_back(p105);
			screeningProbabilities.push_back(p106);
			screeningProbabilities.push_back(p107);
			screeningProbabilities.push_back(p108);
			screeningProbabilities.push_back(p109);
			screeningProbabilities.push_back(p110);
			screeningProbabilities.push_back(p111);
			screeningProbabilities.push_back(p112);
			screeningProbabilities.push_back(p113);
			screeningProbabilities.push_back(p114);
			screeningProbabilities.push_back(p115);
			screeningProbabilities.push_back(p116);
			screeningProbabilities.push_back(p117);
			screeningProbabilities.push_back(p118);
			screeningProbabilities.push_back(p119);
			screeningProbabilities.push_back(p120);
			screeningProbabilities.push_back(p121);
			screeningProbabilities.push_back(p122);
			screeningProbabilities.push_back(p123);
			screeningProbabilities.push_back(p124);
			screeningProbabilities.push_back(p125);
			screeningProbabilities.push_back(p126);
			screeningProbabilities.push_back(p127);
			screeningProbabilities.push_back(p128);
			screeningProbabilities.push_back(p129);
			screeningProbabilities.push_back(p130);
			screeningProbabilities.push_back(p131);
			screeningProbabilities.push_back(p132);
			screeningProbabilities.push_back(p133);
			screeningProbabilities.push_back(p134);
			screeningProbabilities.push_back(p135);
			screeningProbabilities.push_back(p136);
			screeningProbabilities.push_back(p137);
			screeningProbabilities.push_back(p138);
			screeningProbabilities.push_back(p139);
			screeningProbabilities.push_back(p140);
			screeningProbabilities.push_back(p141);
			screeningProbabilities.push_back(p142);
			screeningProbabilities.push_back(p143);
			screeningProbabilities.push_back(p144);
			screeningProbabilities.push_back(p145);
			screeningProbabilities.push_back(p146);
			screeningProbabilities.push_back(p147);
			screeningProbabilities.push_back(p148);
			screeningProbabilities.push_back(p149);
			screeningProbabilities.push_back(p150);
			screeningProbabilities.push_back(p151);
			screeningProbabilities.push_back(p152);
			screeningProbabilities.push_back(p153);
			screeningProbabilities.push_back(p154);
			screeningProbabilities.push_back(p155);
			screeningProbabilities.push_back(p156);
			screeningProbabilities.push_back(p157);
			screeningProbabilities.push_back(p158);
			screeningProbabilities.push_back(p159);
			screeningProbabilities.push_back(p160);
			screeningProbabilities.push_back(p161);
			screeningProbabilities.push_back(p162);
			screeningProbabilities.push_back(p163);
			screeningProbabilities.push_back(p164);
			screeningProbabilities.push_back(p165);
			screeningProbabilities.push_back(p166);
			screeningProbabilities.push_back(p167);
			screeningProbabilities.push_back(p168);
			screeningProbabilities.push_back(p169);
			screeningProbabilities.push_back(p170);
			screeningProbabilities.push_back(p171);
			screeningProbabilities.push_back(p172);
			screeningProbabilities.push_back(p173);
			screeningProbabilities.push_back(p174);
			screeningProbabilities.push_back(p175);
			screeningProbabilities.push_back(p176);
			screeningProbabilities.push_back(p177);
			screeningProbabilities.push_back(p178);
			screeningProbabilities.push_back(p179);
			screeningProbabilities.push_back(p180);
			screeningProbabilities.push_back(p181);
			screeningProbabilities.push_back(p182);
			screeningProbabilities.push_back(p183);
			screeningProbabilities.push_back(p184);
			screeningProbabilities.push_back(p185);
			screeningProbabilities.push_back(p186);
			screeningProbabilities.push_back(p187);
			screeningProbabilities.push_back(p188);
			screeningProbabilities.push_back(p189);
			screeningProbabilities.push_back(p190);
			screeningProbabilities.push_back(p191);
			screeningProbabilities.push_back(p192);
			screeningProbabilities.push_back(p193);
			screeningProbabilities.push_back(p194);
			screeningProbabilities.push_back(p195);
			screeningProbabilities.push_back(p196);
			screeningProbabilities.push_back(p197);
			screeningProbabilities.push_back(p198);
			screeningProbabilities.push_back(p199);
			screeningProbabilities.push_back(p200);
			screeningProbabilities.push_back(p201);
			screeningProbabilities.push_back(p202);
			screeningProbabilities.push_back(p203);
			screeningProbabilities.push_back(p204);
			screeningProbabilities.push_back(p205);
			screeningProbabilities.push_back(p206);
			screeningProbabilities.push_back(p207);
			screeningProbabilities.push_back(p208);
			screeningProbabilities.push_back(p209);
			screeningProbabilities.push_back(p210);
			screeningProbabilities.push_back(p211);
			screeningProbabilities.push_back(p212);
			screeningProbabilities.push_back(p213);
			screeningProbabilities.push_back(p214);
			screeningProbabilities.push_back(p215);
		}
