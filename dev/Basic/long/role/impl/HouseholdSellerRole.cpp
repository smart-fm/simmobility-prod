...
namespace
{
    ...
    //bid_timestamp ,seller_id, bidder_id, unit_id, bidder wp, affordability, logsum, hedonicprice, asking_price, floor_area, type_id, target_price, bid_value, bids_counter (daily), status(0 - REJECTED, 1- ACCEPTED), HHPC, UPC
