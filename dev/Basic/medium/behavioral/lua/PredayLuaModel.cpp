...
void sim_mob::medium::PredayLuaModel::mapClasses()
{
    getGlobalNamespace(state.get())
            ...
            .beginClass<TourModeParams>("TourModeParams")
                ...
                .addProperty("wtt_sms_first",&TourModeParams::getWTtSMSFirst)
                .addProperty("wtt_sms_pool_first",&TourModeParams::getWTtSMSPoolFirst)
                .addProperty("wtt_amod_first",&TourModeParams::getWTtAMODFirst)
                .addProperty("wtt_amod_pool_first",&TourModeParams::getWTtAMODPoolFirst)
                .addProperty("wait_amod_minibus_first",&TourModeParams::getWTtAMODMinibusFirst)
                .addProperty("wtt_sms_second",&TourModeParams::getWTtSMSSecond)
                .addProperty("wtt_sms_pool_second",&TourModeParams::getWTtSMSPoolSecond)
                .addProperty("wtt_amod_second",&TourModeParams::getWTtAMODSecond)
                .addProperty("wtt_amod_pool_second",&TourModeParams::getWTtAMODPoolSecond)
                .addProperty("wait_amod_minibus_second",&TourModeParams::getWTtAMODMinibusSecond)
            ...
            .beginClass<TourModeDestinationParams>("TourModeDestinationParams")
                ...
                .addFunction("wtt_sms_first",&TourModeDestinationParams::getWTtSMSFirst)
                .addFunction("wtt_sms_pool_first",&TourModeDestinationParams::getWTtSMSPoolFirst)
                .addFunction("wtt_amod_first",&TourModeDestinationParams::getWTtAMODFirst)
                .addFunction("wtt_amod_pool_first",&TourModeDestinationParams::getWTtAMODPoolFirst)
                .addFunction("wait_amod_minibus_first",&TourModeDestinationParams::getWTtAMODMinibusFirst)
                .addFunction("wtt_sms_second",&TourModeDestinationParams::getWTtSMSSecond)
                .addFunction("wtt_sms_pool_second",&TourModeDestinationParams::getWTtSMSPoolSecond)
                .addFunction("wtt_amod_second",&TourModeDestinationParams::getWTtAMODSecond)
                .addFunction("wtt_amod_pool_second",&TourModeDestinationParams::getWTtAMODPoolSecond)
                .addFunction("wait_amod_minibus_second",&TourModeDestinationParams::getWTtAMODMinibusSecond)
            ...
            .beginClass<StopModeDestinationParams>("StopModeDestinationParams")
                ...
                .addFunction("wtt_sms",&StopModeDestinationParams::getWTtSMS)
                .addFunction("wtt_sms_pool",&StopModeDestinationParams::getWTtSMSPool)
                .addFunction("wtt_amod",&StopModeDestinationParams::getWTtAMOD)
                .addFunction("wtt_amod_pool",&StopModeDestinationParams::getWTtAMODPool)
                .addFunction("wait_amod_minibus",&StopModeDestinationParams::getWTtAMODMinibus)
...
int sim_mob::medium::PredayLuaModel::predictStopModeDestination(PersonParams& personParams, StopModeDestinationParams& imdParams) const
{
    ...
    if (imdParams.areAllStopModeDestinationsUnavailable())
        return -1;
    return retVal.cast<int>();
}
