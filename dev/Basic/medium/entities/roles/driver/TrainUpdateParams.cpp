...
TrainUpdateParams::TrainUpdateParams():currentSpeed(0),secondsInTick(1.0),elapsedSeconds(0),disToNextPlatform(0),currentSpeedLimit(0),currentAcelerate(0),disToNextTrain(0) {
