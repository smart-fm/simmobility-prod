...
//
//	activity->location = const_cast<sim_mob::Node*> (sim_mob::Node::);
//	return activity;
//}
...
//void UnPackageUtils::unpackDriverUpdateParams(DriverUpdateParams& one_driver) const {
...
//}
//
//void UnPackageUtils::unpackPedestrianUpdateParams(PedestrianUpdateParams& one_pedestrain) const {
