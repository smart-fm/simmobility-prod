...
local function computeAvailabilities(params,dbparams)
	...
	for i = 1, 48 do 
		...
		-- print(" Utility for option ",i," ",utility[i]," Time interval ",arrmidpoint[i]," Avaliability ",availability[i])
	end
end
...
function choose_itd(params,dbparams)
	...
	if temp_choice == 48 then
		print("PersonID: ",params.person_id," ITD: ",temp_choice," ",arrmidpoint[temp_choice])
	end
	return temp_choice
