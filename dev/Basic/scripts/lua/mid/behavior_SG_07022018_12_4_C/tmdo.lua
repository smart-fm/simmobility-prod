...
local beta_cons_SMS_pool = 0.314
local beta_cons_rail_SMS_pool = -1.69
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_rail_SMS_pool[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_pool_avg[i] * 2 * 0.6*0.7+1
