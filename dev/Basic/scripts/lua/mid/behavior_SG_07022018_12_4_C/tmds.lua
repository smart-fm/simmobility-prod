...
local beta_cons_SMS_pool = -19.440
local beta_cons_rail_SMS_pool = -8.610
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_SMS[i] = (cost_SMS_1[i] + cost_SMS_2[i])*0.6 + cost_increase +1
		...
		cost_SMS_pool[i] = (cost_SMS_pool_1[i] + cost_SMS_pool_2[i])*0.6*0.7 + cost_increase +1
		...
		cost_rail_SMS[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_avg[i] * 2 * 0.6 +1
		...
		cost_rail_SMS_pool[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_avg[i] * 2 * 0.6 *0.7 +1
