...
local beta_tt_SMS = 0
local beta_tt_rail_SMS = 0
local beta_tt_SMS_pool = 0
local beta_tt_rail_SMS_pool = 0
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		tt_bus[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+tt_public_out_first[i]+tt_public_out_second[i]+1/60
		tt_mrt[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+tt_public_out_first[i]+tt_public_out_second[i]+1/60
		tt_private_bus[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i]+1/60
		tt_drive1[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_share2[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_share3[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_motor[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_walk[i] = (d1[i]+d2[i])/5+1/60
		tt_taxi[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_SMS[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6+1/60
		tt_rail_SMS[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])/6+1/60
		tt_SMS_pool[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i]+1.0/6 + 1/10+(d1[i]+d2[i])/2/60 + 1.0/6+1/60
		tt_rail_SMS_pool[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])/6 +(aed+aed)/60+1/10+1/60
