...
local beta_cons_rail_SMS = -9.159
local beta_cons_SMS_pool = -16.376
local beta_cons_rail_SMS_pool = -15.159

local beta1_1_tt = 0
local beta1_2_tt = 0
local beta1_3_tt = 0

local beta_private_1_tt= 0
...
local function computeUtilities(params,dbparams)
	...
	local tt_bus_all=tt_bus_ivt+tt_bus_wait+tt_bus_walk + 1.0/60
	...
	local tt_mrt_all=tt_mrt_ivt+tt_mrt_wait+tt_mrt_walk + 1.0/60
	...
	local tt_privatebus_ivt = tt_privatebus_ivt * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 
	local tt_privatebus_wait = tt_privatebus_wait * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 
	local tt_privatebus_walk = tt_privatebus_walk * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 
