...
bundled_variables.beta_cons_SMS_pool =  -7.191
bundled_variables.beta_cons_rail_SMS_pool =  -7.902

local beta1_1_tt = 0
local beta1_2_tt = 0
local beta1_3_tt = 0

bundled_variables.beta_private_1_tt = 0

local beta2_tt_drive1 = 0
local beta2_tt_share2 = 0
local beta2_tt_share3 = 0
local beta2_tt_motor = 0

bundled_variables.beta_tt_walk = 0
bundled_variables.beta_tt_taxi = 0
bundled_variables.beta_tt_SMS = 0
bundled_variables.beta_tt_SMS_pool = 0
...
local modes = {['BusTravel'] = 1 , ['MRT'] =2 ,  ['Car'] = 3,  ['Car_Sharing_2'] = 4,
	...
	['Rail_SMS'] = 10, ['SMS_pool'] = 11, ['Rail_SMS_pool'] = 12 }
...
local function computeUtilities(params,dbparams)
	...
	local tt_bus_all=tt_bus_ivt+tt_bus_wait+tt_bus_walk+1/60
	
	tt_bus_ivt = tt_bus_ivt * (1.0/(60 * tt_bus_all - 1.0) + 1) 
	tt_bus_wait = tt_bus_wait * (1.0/(60 * tt_bus_all - 1.0) + 1)
	tt_bus_walk = tt_bus_walk * (1.0/(60 * tt_bus_all - 1.0) + 1)
	...
	local tt_mrt_all=tt_mrt_ivt+tt_mrt_wait+tt_mrt_walk+1/60

	tt_mrt_ivt = tt_mrt_ivt * (1.0/(60 * tt_bus_all - 1.0) + 1) 
	tt_mrt_wait = tt_mrt_wait * (1.0/(60 * tt_bus_all - 1.0) + 1) 
	tt_mrt_walk = tt_mrt_walk * (1.0/(60 * tt_bus_all - 1.0) + 1) 
	...
	local tt_rail_SMS_all=tt_mrt_ivt+tt_mrt_wait+tt_mrt_walk+1/60
	
	tt_rail_SMS_ivt = tt_rail_SMS_ivt * (1.0/(60 * tt_rail_SMS_all - 1.0) + 1) 
	tt_rail_SMS_wait = tt_rail_SMS_wait * (1.0/(60 * tt_rail_SMS_all - 1.0) + 1) 
	tt_rail_SMS_walk = tt_rail_SMS_walk * (1.0/(60 * tt_rail_SMS_all - 1.0) + 1)
	...
	local tt_rail_SMS_pool_all=tt_mrt_ivt+tt_mrt_wait+tt_mrt_walk+1/60
	
	tt_rail_SMS_pool_ivt = tt_rail_SMS_pool_ivt * (1.0/(60 * tt_rail_SMS_pool_all - 1.0) + 1) 
	tt_rail_SMS_pool_wait = tt_rail_SMS_pool_wait * (1.0/(60 * tt_rail_SMS_pool_all - 1.0) + 1) 
	tt_rail_SMS_pool_walk = tt_rail_SMS_pool_walk * (1.0/(60 * tt_rail_SMS_pool_all - 1.0) + 1)
	...
	local tt_privatebus_all=tt_privatebus_ivt+tt_privatebus_wait+tt_privatebus_walk+1/60
	
	tt_privatebus_ivt = tt_privatebus_ivt * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 
	tt_privatebus_wait = tt_privatebus_wait * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 
	tt_privatebus_walk = tt_privatebus_walk * (1.0/(60 * tt_privatebus_all - 1.0) + 1) 

	local tt_cardriver_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_cardriver_out=1.0/6
	local tt_cardriver_all=tt_cardriver_ivt+tt_cardriver_out+1/60

	local tt_carpassenger_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_carpassenger_out=1.0/6
	local tt_carpassenger_all=tt_carpassenger_ivt+tt_carpassenger_out+1/60

	local tt_motor_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_motor_out=1.0/6
	local tt_motor_all=tt_motor_ivt+tt_motor_out+1/60

	local tt_walk=(d1+d2)/5+1/60

	local tt_taxi_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_taxi_out=1.0/6
	local tt_taxi_all=tt_cardriver_ivt+tt_cardriver_out+1/60

	local tt_SMS_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_SMS_out=1.0/6
	local tt_SMS_all=tt_cardriver_ivt+tt_cardriver_out+1/60

	local tt_SMS_pool_ivt=tt_ivt_car_first+tt_ivt_car_second+(d1+d2)/2/60
	local tt_SMS_pool_out=1.0/6+1/10
	local tt_SMS_pool_all=tt_cardriver_ivt+tt_cardriver_out+1/60
