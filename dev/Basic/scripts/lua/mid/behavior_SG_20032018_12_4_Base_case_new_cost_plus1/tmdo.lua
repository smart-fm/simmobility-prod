...
local beta_cons_share2 = -0.555
local beta_cons_share3 = 0.213
local beta_cons_motor = 8.120
local beta_cons_walk = 3.289
local beta_cons_taxi = 1.925
local beta_cons_SMS = 2.425
local beta_cons_Rail_SMS = 5.081 
local beta_cons_SMS_Pool = 1.681  
local beta_cons_Rail_SMS_Pool = -8.976
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_Rail_SMS_Pool[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_Pool_avg[i] * 2 * 0.72*0.7 + 1
