...
local beta_cons_private_bus = -7.566
local beta_cons_drive1 = 0
local beta_cons_share2 = -10.514
local beta_cons_share3 = -11.705
local beta_cons_motor = -5.218
local beta_cons_walk = -6.994
local beta_cons_taxi = -10.535
local beta_cons_SMS = -10.035
local beta_cons_Rail_SMS = -11.493
local beta_cons_SMS_Pool = -13.993
local beta_cons_Rail_SMS_Pool =  -22.616
...
local beta_female_Rail_SMS_Pool = 1.60
local beta_female_SMS_Pool = 2.89
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_bus[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1
		cost_mrt[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1
		
		cost_private_bus[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1
		...
		--0 if origin == destination
		cost_drive1[i] = dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase + 1
		cost_share2[i] = (dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase)/2 + 1
		cost_share3[i] = (dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase)/3 + 1
		cost_motor[i] = 0.5*(dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i))+0.65*dbparams:cost_car_parking(i)+cost_increase + 1
		...
		cost_taxi[i] = cost_taxi_1[i] + cost_taxi_2[i] + cost_increase + 1
		...
		cost_SMS[i] = (cost_SMS_1[i] + cost_SMS_2[i])*0.72 + cost_increase + 1
		...
		cost_SMS_Pool[i] = (cost_SMS_Pool_1[i] + cost_SMS_Pool_2[i])*0.72*0.7 + cost_increase + 1
		...
		cost_Rail_SMS[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_avg[i] * 2 * 0.72 + 1
		...
		cost_Rail_SMS_Pool[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_avg[i] * 2 * 0.72 *0.7 + 1
