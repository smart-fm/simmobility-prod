...
local function computeUtilities(params,dbparams)
	...
	local cost_SMS=(cost_SMS_1+cost_SMS_2)*0.72 + cost_increase + 1
	...
	local cost_SMS_Pool=(cost_SMS_1+cost_SMS_2)*0.72*0.7 + cost_increase + 1
	...
	local cost_Rail_SMS = cost_public_first + cost_public_second + cost_increase + (cost_Rail_SMS_AE_1 + cost_Rail_SMS_AE_2) * 0.72	+ 1
	...
	local cost_Rail_SMS_Pool = cost_public_first + cost_public_second + cost_increase + (cost_Rail_SMS_AE_Pool_1 + cost_Rail_SMS_AE_Pool_2) * 0.72 * 0.7 + 1	
