...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_SMS[i] = (cost_SMS_1[i] + cost_SMS_2[i])*0.64
		...
		cost_SMS_Pool[i] = (cost_SMS_Pool_1[i] + cost_SMS_Pool_2[i])*0.64*0.7
		...
		cost_Rail_SMS[i] = cost_mrt[i] + cost_Rail_SMS_AE_avg[i]*0.64
		...
		cost_Rail_SMS_Pool[i] = cost_mrt[i] + cost_Rail_SMS_AE_Pool_avg[i]*0.64*0.7
