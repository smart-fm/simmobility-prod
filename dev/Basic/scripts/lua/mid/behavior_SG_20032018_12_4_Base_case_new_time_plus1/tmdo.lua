...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		tt_SMS_Pool[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1/10+(d1[i]+d2[i])/2/60 + 1/60
		tt_Rail_SMS_Pool[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(aed+aed)/60+(tt_public_out_first[i]+tt_public_out_second[i])/6.0+1/10 + 1/60
