...
local beta_cons_privatebus= -6.031
local beta_cons_drive1= 0
local beta_cons_share2= -9.798
local beta_cons_share3= -9.987
local beta_cons_motor= 9.992
local beta_cons_walk= -3.704
local beta_cons_taxi= -11.334
local beta_cons_SMS = -10.834
local beta_cons_Rail_SMS = -12.492
local beta_cons_SMS_Pool = -14.992
local beta_cons_Rail_SMS_Pool = -23.865
