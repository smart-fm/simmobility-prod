...
local beta_cost_bus_mrt_1= -1000
local beta_cost_private_bus_1 = -1000
local beta_cost_drive1_1 = -1000
local beta_cost_share2_1 = -1000
local beta_cost_share3_1 = -1000
local beta_cost_motor_1 = -1000
local beta_cost_taxi_1 = -1000
local beta_cost_SMS_1 = -1000
local beta_cost_Rail_SMS_1 = -1000
local beta_cost_SMS_Pool_1 = -1000
local beta_cost_Rail_SMS_Pool_1 = -1000

local beta_cost_bus_mrt_2 = -1000
local beta_cost_private_bus_2 = -1000
local beta_cost_drive1_2 = -1000
local beta_cost_share2_2 = -1000
local beta_cost_share3_2 = -1000
local beta_cost_motor_2 = -1000
local beta_cost_taxi_2 = -1000
local beta_cost_SMS_2 = -1000
local beta_cost_Rail_SMS_2 = -1000
local beta_cost_SMS_Pool_2 = -1000
local beta_cost_Rail_SMS_Pool_2 = -1000

local beta_tt_bus_mrt = -1000
local beta_tt_private_bus= -1000
local beta_tt_drive1 = -1000
local beta_tt_share2 = -1000
local beta_tt_share3 = -1000
local beta_tt_motor = -1000
local beta_tt_walk = -1000
local beta_tt_taxi= -1000
local beta_tt_SMS = -1000
local beta_tt_Rail_SMS = -1000
local beta_tt_SMS_Pool = -1000
local beta_tt_Rail_SMS_Pool = -1000
