...
local modes = {['BusTravel'] = 1 , ['MRT'] =2,  ['Car'] = 3,  ['Car_Sharing_2'] = 4,['Car_Sharing_3'] = 5, ['Walk'] = 6, ['AMOD'] =7, ['Rail_AMOD'] = 8, ['AMOD_Pool'] = 9, ['Rail_AMOD_Pool'] = 10 }
...
local function computeUtilities(params,dbparams)
	...
	utility[6] = beta_cons_walk  + beta_tt_walk * tt_walk + beta_central_walk * central_dummy+ beta_female_walk * female_dummy + age_over_15*beta_age_over_15_walk + university_student * beta_university_student_walk
	...
	utility[7] = beta_cons_AMOD + beta_tt_AMOD * tt_AMOD_all + beta_cost * cost_AMOD + beta_central_AMOD * central_dummy + beta_female_AMOD * female_dummy + age_over_15*beta_age_over_15_AMOD + university_student * beta_university_student_AMOD
	utility[8] = beta_cons_Rail_AMOD + beta1_1_tt * tt_Rail_AMOD_ivt + beta1_2_tt * tt_Rail_AMOD_walk + beta1_3_tt * tt_Rail_AMOD_wait + beta_cost * cost_Rail_AMOD + beta_central_Rail_AMOD * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_AMOD * female_dummy + age_over_15 * beta_age_over_15_Rail_AMOD + university_student * beta_university_student_Rail_AMOD
	utility[9] = beta_cons_AMOD_Pool + beta_tt_AMOD_Pool * tt_AMOD_Pool_all + beta_cost * cost_AMOD_Pool + beta_central_AMOD_Pool * central_dummy + beta_female_AMOD_Pool * female_dummy + age_over_15*beta_age_over_15_AMOD_Pool + university_student * beta_university_student_AMOD_Pool
	utility[10] = beta_cons_Rail_AMOD_Pool + beta1_1_tt * tt_Rail_AMOD_Pool_ivt + beta1_2_tt * tt_Rail_AMOD_Pool_walk + beta1_3_tt * tt_Rail_AMOD_Pool_wait + beta_cost * cost_Rail_AMOD_Pool + beta_central_Rail_AMOD_Pool * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_AMOD_Pool * female_dummy + age_over_15 * beta_age_over_15_Rail_AMOD_Pool + university_student * beta_university_student_Rail_AMOD_Pool
end
