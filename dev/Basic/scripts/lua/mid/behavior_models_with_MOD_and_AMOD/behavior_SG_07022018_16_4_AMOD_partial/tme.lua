...
local beta_cons_walk= -4.304
local beta_cons_taxi= -11.934
local beta_cons_SMS = -11.999
local beta_cons_Rail_SMS = -10.659
local beta_cons_SMS_Pool = -16.876
local beta_cons_Rail_SMS_Pool = -16.159
local beta_cons_AMOD = -11.999
local beta_cons_Rail_AMOD = -10.659
local beta_cons_AMOD_Pool = -16.876
local beta_cons_Rail_AMOD_Pool = -16.159
...
local beta_tt_AMOD = -2.84
local beta_tt_AMOD_Pool = -2.84
...
local beta_central_AMOD = 1.04
local beta_central_Rail_AMOD = 0.502
local beta_central_AMOD_Pool = 1.04
local beta_central_Rail_AMOD_Pool = 0.502

local beta_female_bus = 0.804
local beta_female_mrt = 0.916
local beta_female_Rail_AMOD = 0.916
local beta_female_Rail_AMOD_Pool = 0.916
...
local beta_female_AMOD = 0.567
local beta_female_AMOD_Pool = 0.567
...
local beta_age_over_15_Rail_AMOD = 2.46
local beta_age_over_15_Rail_AMOD_Pool = 2.46
...
local beta_age_over_15_AMOD = 0.772
local beta_age_over_15_AMOD_Pool = 0.772

local beta_university_student_bus = -0.157
local beta_university_student_mrt = 0.308
local beta_university_student_Rail_AMOD = 0.308
local beta_university_student_Rail_AMOD_Pool = 0.308
...
local beta_university_student_AMOD = 2.10
local beta_university_student_AMOD_Pool = 2.10

local beta_distance_motor = 0


local modes = {['BusTravel'] = 1 , ['MRT'] =2,  ['Car'] = 3,  ['Car_Sharing_2'] = 4,['Car_Sharing_3'] = 5, ['Motorcycle'] = 6,['Walk'] = 7, ['Taxi'] = 8, ['SMS'] =9, ['Rail_SMS'] = 10, ['SMS_Pool'] = 11, ['Rail_SMS_Pool'] = 12, ['AMOD'] =13, ['Rail_AMOD'] = 14, ['AMOD_Pool'] = 15, ['Rail_AMOD_Pool'] = 16 }
...
-- 11 for Rail_SMS
local choice = {}
choice["PT"] = {1,2,10,12,14,16}
choice["car"] = {3,4,5,6}
choice["other"] = {7,8,9,11,13,15}
...
local function computeUtilities(params,dbparams)
	...
	local cost_SMS_Pool=(cost_SMS_1+cost_SMS_2)*0.6*0.7 + cost_increase
	...
	local cost_AMOD_Pool=(cost_AMOD_1+cost_AMOD_2)*0.6*0.7/3 + cost_increase
	...
	local cost_over_income_AMOD_Pool=30*cost_AMOD_Pool/(0.5+income_mid) 	
	local cost_over_income_Rail_AMOD=30*cost_Rail_AMOD/(0.5+income_mid)
	local cost_over_income_Rail_AMOD_Pool=30*cost_Rail_AMOD_Pool/(0.5+income_mid)
	...
	local tt_Rail_SMS_all=tt_Rail_SMS_ivt+tt_Rail_SMS_wait+tt_Rail_SMS_walk
	...
	local tt_Rail_SMS_Pool_all=tt_Rail_SMS_Pool_ivt+tt_Rail_SMS_Pool_wait+tt_Rail_SMS_Pool_walk
	
	local tt_Rail_AMOD_ivt=tt_public_ivt_first+tt_public_ivt_second
	local tt_Rail_AMOD_wait=1/6.0+1/6.0+tt_public_waiting_first+tt_public_waiting_second
	...
	local tt_Rail_AMOD_Pool_wait=1/6.0+1/6.0+tt_public_waiting_first+tt_public_waiting_second+1/10
	...
	utility[4] = beta_cons_share2 + beta2_tt_share2 * tt_carpassenger_all + beta_cost * cost_carpassenger/2.0  + beta_central_share2 * central_dummy + beta_female_share2 * female_dummy + beta_zero_share2 * zero_car + beta_oneplus_share2 * one_plus_car + beta_twoplus_share2 * two_plus_car + beta_threeplus_share2 * three_plus_car + age_over_15*beta_age_over_15_share2 + university_student * beta_university_student_share2
	...
	utility[6] = beta_cons_motor + beta2_tt_motor * tt_motor_all + beta_cost * cost_motor + beta_central_motor * central_dummy + beta_zero_motor * zero_motor + beta_oneplus_motor * one_plus_motor + beta_twoplus_motor * two_plus_motor + beta_threeplus_motor * three_plus_motor + beta_female_motor * female_dummy + age_over_15*beta_age_over_15_motor + university_student * beta_university_student_motor + beta_distance_motor * (d1+d2)
	utility[7] = beta_cons_walk  + beta_tt_walk * tt_walk + beta_central_walk * central_dummy+ beta_female_walk * female_dummy + age_over_15*beta_age_over_15_walk + university_student * beta_university_student_walk
	utility[8] = beta_cons_taxi + beta_tt_taxi * tt_taxi_all + beta_cost * cost_taxi + beta_central_taxi * central_dummy + beta_female_taxi * female_dummy + age_over_15*beta_age_over_15_taxi + university_student * beta_university_student_taxi
	utility[9] = beta_cons_SMS + beta_tt_SMS * tt_SMS_all + beta_cost * cost_SMS + beta_central_SMS * central_dummy + beta_female_SMS * female_dummy + age_over_15*beta_age_over_15_SMS + university_student * beta_university_student_SMS
	utility[10] = beta_cons_Rail_SMS + beta1_1_tt * tt_Rail_SMS_ivt + beta1_2_tt * tt_Rail_SMS_walk + beta1_3_tt * tt_Rail_SMS_wait + beta_cost * cost_Rail_SMS + beta_central_Rail_SMS * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_SMS * female_dummy + age_over_15 * beta_age_over_15_Rail_SMS + university_student * beta_university_student_Rail_SMS
	utility[11] = beta_cons_SMS_Pool + beta_tt_SMS_Pool * tt_SMS_Pool_all + beta_cost * cost_SMS_Pool + beta_central_SMS_Pool * central_dummy + beta_female_SMS_Pool * female_dummy + age_over_15*beta_age_over_15_SMS_Pool + university_student * beta_university_student_SMS_Pool
	utility[12] = beta_cons_Rail_SMS_Pool + beta1_1_tt * tt_Rail_SMS_Pool_ivt + beta1_2_tt * tt_Rail_SMS_Pool_walk + beta1_3_tt * tt_Rail_SMS_Pool_wait + beta_cost * cost_Rail_SMS_Pool + beta_central_Rail_SMS_Pool * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_SMS_Pool * female_dummy + age_over_15 * beta_age_over_15_Rail_SMS_Pool + university_student * beta_university_student_Rail_SMS_Pool
	utility[13] = beta_cons_AMOD + beta_tt_AMOD * tt_AMOD_all + beta_cost * cost_AMOD + beta_central_AMOD * central_dummy + beta_female_AMOD * female_dummy + age_over_15*beta_age_over_15_AMOD + university_student * beta_university_student_AMOD
	utility[14] = beta_cons_Rail_AMOD + beta1_1_tt * tt_Rail_AMOD_ivt + beta1_2_tt * tt_Rail_AMOD_walk + beta1_3_tt * tt_Rail_AMOD_wait + beta_cost * cost_Rail_AMOD + beta_central_Rail_AMOD * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_AMOD * female_dummy + age_over_15 * beta_age_over_15_Rail_AMOD + university_student * beta_university_student_Rail_AMOD
	utility[15] = beta_cons_AMOD_Pool + beta_tt_AMOD_Pool * tt_AMOD_Pool_all + beta_cost * cost_AMOD_Pool + beta_central_AMOD_Pool * central_dummy + beta_female_AMOD_Pool * female_dummy + age_over_15*beta_age_over_15_AMOD_Pool + university_student * beta_university_student_AMOD_Pool
	utility[16] = beta_cons_Rail_AMOD_Pool + beta1_1_tt * tt_Rail_AMOD_Pool_ivt + beta1_2_tt * tt_Rail_AMOD_Pool_walk + beta1_3_tt * tt_Rail_AMOD_Pool_wait + beta_cost * cost_Rail_AMOD_Pool + beta_central_Rail_AMOD_Pool * central_dummy + beta_transfer * average_transfer_number + beta_female_Rail_AMOD_Pool * female_dummy + age_over_15 * beta_age_over_15_Rail_AMOD_Pool + university_student * beta_university_student_Rail_AMOD_Pool
end
