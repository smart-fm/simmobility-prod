...
bundled_variables.beta_cons_privatebus = -4.91
bundled_variables.beta_cons_drive1 = 0
bundled_variables.beta_cons_share2 = -7.431
bundled_variables.beta_cons_share3 = -6.132
bundled_variables.beta_cons_motor = -2.742
bundled_variables.beta_cons_walk = 4.096
bundled_variables.beta_cons_taxi = -5.417
bundled_variables.beta_cons_SMS =  -5.482
bundled_variables.beta_cons_Rail_SMS =  -4.138
bundled_variables.beta_cons_SMS_Pool =  -7.691
bundled_variables.beta_cons_Rail_SMS_Pool =  -10.402
bundled_variables.beta_cons_AMOD =  -5.482
bundled_variables.beta_cons_Rail_AMOD =  -4.138
bundled_variables.beta_cons_AMOD_Pool =  -7.691
bundled_variables.beta_cons_Rail_AMOD_Pool =  -10.402
...
bundled_variables.beta_tt_AMOD = -1.17
bundled_variables.beta_tt_AMOD_Pool = -1.17
...
bundled_variables.beta_central_AMOD = 1.11
bundled_variables.beta_central_Rail_AMOD = 1.13
bundled_variables.beta_central_AMOD_Pool = 1.11
bundled_variables.beta_central_Rail_AMOD_Pool = 1.13
...
bundled_variables.beta_female_oneplus_Rail_AMOD = 1.73
bundled_variables.beta_female_twoplus_Rail_AMOD = -1.58

bundled_variables.beta_female_oneplus_Rail_AMOD_Pool = 1.73
bundled_variables.beta_female_twoplus_Rail_AMOD_Pool = -1.58
...
bundled_variables.beta_female_oneplus_AMOD = 0.826
bundled_variables.beta_female_twoplus_AMOD = 0

bundled_variables.beta_female_oneplus_AMOD_Pool = 0.826
bundled_variables.beta_female_twoplus_AMOD_Pool = 0
...
bundled_variables.beta_oneplus_Rail_AMOD = -1.43
bundled_variables.beta_twoplus_Rail_AMOD = 0.525
bundled_variables.beta_threeplus_Rail_AMOD = 0

bundled_variables.beta_zero_Rail_AMOD_Pool = 0
bundled_variables.beta_oneplus_Rail_AMOD_Pool = -1.43
bundled_variables.beta_twoplus_Rail_AMOD_Pool = 0.525
...
bundled_variables.beta_zero_AMOD = 0
bundled_variables.beta_oneplus_AMOD = 0
bundled_variables.beta_twoplus_AMOD = 0
bundled_variables.beta_threeplus_AMOD = 0

bundled_variables.beta_zero_AMOD_Pool = 0
bundled_variables.beta_oneplus_AMOD_Pool = 0
...
bundled_variables.beta_age2025_zero_car_Rail_AMOD = -1.04
bundled_variables.beta_age2635_zero_car_Rail_AMOD = 1.73

bundled_variables.beta_age2025_zero_car_Rail_AMOD_Pool = -1.04
bundled_variables.beta_age2635_zero_car_Rail_AMOD_Pool = 1.73
...
bundled_variables.beta_age2635_zero_car_AMOD=2.34
bundled_variables.beta_age2635_one_plus_car_AMOD=0.271
bundled_variables.beta_age3650_one_plus_car_AMOD=-0.428
bundled_variables.beta_age5165_zero_car_AMOD=0.673
bundled_variables.beta_age65_zero_car_AMOD=2.33

bundled_variables.beta_age2635_zero_car_AMOD_Pool=2.34
bundled_variables.beta_age2635_one_plus_car_AMOD_Pool=0.271
bundled_variables.beta_age3650_one_plus_car_AMOD_Pool=-0.428
bundled_variables.beta_age5165_zero_car_AMOD_Pool=0.673
bundled_variables.beta_age65_zero_car_AMOD_Pool=2.33
...
local modes = {['BusTravel'] = 1 , ['MRT'] =2 ,  ['Car'] = 3,  ['Car_Sharing_2'] = 4,
	['Car_Sharing_3'] = 5, ['Motorcycle'] = 6,['Walk'] = 7, ['Taxi'] = 8 , ['SMS'] = 9,
	['Rail_SMS'] = 10, ['SMS_Pool'] = 11, ['Rail_SMS_Pool'] = 12, ['AMOD'] = 13,
	['Rail_AMOD'] = 14, ['AMOD_Pool'] = 15, ['Rail_AMOD_Pool'] = 16 }



--choice["PT"] = {1,2,3,10,12,14,16}
--choice["non-PT"] = {4,5,6,7,8,9,11,13,15}
...
local function computeUtilities(params,dbparams)
	...
	local cost_AMOD_1=3.4+((d1*(d1>10 and 1 or 0)-10*(d1>10 and 1 or 0))/0.35+(d1*(d1<=10 and 1 or 0)+10*(d1>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_first + central_dummy*3
	local cost_AMOD_2=3.4+((d2*(d2>10 and 1 or 0)-10*(d2>10 and 1 or 0))/0.35+(d2*(d2<=10 and 1 or 0)+10*(d2>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_second + central_dummy*3
	local cost_AMOD=(cost_AMOD_1+cost_AMOD_2)*0.6/3 + cost_increase

	local cost_AMOD_Pool_1=3.4+((d1*(d1>10 and 1 or 0)-10*(d1>10 and 1 or 0))/0.35+(d1*(d1<=10 and 1 or 0)+10*(d1>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_first + central_dummy*3
	local cost_AMOD_Pool_2=3.4+((d2*(d2>10 and 1 or 0)-10*(d2>10 and 1 or 0))/0.35+(d2*(d2<=10 and 1 or 0)+10*(d2>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_second + central_dummy*3
	local cost_AMOD_Pool=(cost_AMOD_Pool_1+cost_AMOD_Pool_2)*0.6*0.7/3 + cost_increase
	...
	local cost_Rail_AMOD_AE_Pool_1 = 3.4+((aed_1*(aed_1>10 and 1 or 0)-10*(aed_1>10 and 1 or 0))/0.35+(aed_1*(aed_1<=10 and 1 or 0)+10*(aed_1>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_first + central_dummy*3
	local cost_Rail_AMOD_AE_Pool_2 = 3.4+((aed_2*(aed_2>10 and 1 or 0)-10*(aed_2>10 and 1 or 0))/0.35+(aed_2*(aed_2<=10 and 1 or 0)+10*(aed_2>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_second + central_dummy*3

	local cost_Rail_AMOD_Pool = cost_public_first + cost_public_second + cost_increase + (cost_Rail_AMOD_AE_Pool_1 + cost_Rail_AMOD_AE_Pool_2)*0.6*0.7/3

	local cost_Rail_AMOD_AE_1 = 3.4+((aed_1*(aed_1>10 and 1 or 0)-10*(aed_1>10 and 1 or 0))/0.35+(aed_1*(aed_1<=10 and 1 or 0)+10*(aed_1>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_first + central_dummy*3
	local cost_Rail_AMOD_AE_2 = 3.4+((aed_2*(aed_2>10 and 1 or 0)-10*(aed_2>10 and 1 or 0))/0.35+(aed_2*(aed_2<=10 and 1 or 0)+10*(aed_2>10 and 1 or 0))/0.4)*0.22+ cost_car_ERP_second + central_dummy*3

	local cost_Rail_AMOD = cost_public_first + cost_public_second + cost_increase + (cost_Rail_AMOD_AE_1 + cost_Rail_AMOD_AE_2) * 0.6/3
	...
	local cost_over_income_AMOD=30*cost_AMOD/(0.5+income_mid)
	local cost_over_income_Rail_AMOD=30*cost_Rail_AMOD/(0.5+income_mid)
	local cost_over_income_AMOD_Pool=30*cost_AMOD/(0.5+income_mid)
	local cost_over_income_Rail_AMOD_Pool=30*cost_Rail_AMOD/(0.5+income_mid)
	...
	local tt_Rail_AMOD_ivt=tt_public_ivt_first+tt_public_ivt_second
	local tt_Rail_AMOD_wait=tt_public_waiting_first+tt_public_waiting_second+1/6.0+1/6.0
	local tt_Rail_AMOD_walk=(tt_public_walk_first+tt_public_walk_second)/8.0
	local tt_Rail_AMOD_all=tt_Rail_AMOD_ivt+tt_Rail_AMOD_wait+tt_Rail_AMOD_walk

	local tt_Rail_AMOD_Pool_ivt=tt_public_ivt_first+tt_public_ivt_second+(aed_1+aed_2)/60
	local tt_Rail_AMOD_Pool_wait=tt_public_waiting_first+tt_public_waiting_second+1/6.0+1/6.0+1/10
	local tt_Rail_AMOD_Pool_walk=(tt_public_walk_first+tt_public_walk_second)/8.0
	local tt_Rail_AMOD_Pool_all=tt_Rail_AMOD_Pool_ivt+tt_Rail_AMOD_Pool_wait+tt_Rail_AMOD_Pool_walk
	...
	local tt_taxi_all=tt_taxi_ivt+tt_taxi_out

	local tt_SMS_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_SMS_out=1.0/6
	local tt_SMS_all=tt_SMS_ivt+tt_SMS_out
	...
	local tt_AMOD_ivt=tt_ivt_car_first+tt_ivt_car_second
	local tt_AMOD_out=1.0/6
	local tt_AMOD_all=tt_AMOD_ivt+tt_AMOD_out

	local tt_AMOD_Pool_ivt=tt_ivt_car_first+tt_ivt_car_second+(d1+d2)/2/60
...
local function computeAvailabilities(params,dbparams)
	availability = {
		...
		dbparams:getModeAvailability(modes.AMOD),
		dbparams:getModeAvailability(modes.Rail_AMOD),
		dbparams:getModeAvailability(modes.AMOD_Pool),
		dbparams:getModeAvailability(modes.Rail_AMOD_Pool)
