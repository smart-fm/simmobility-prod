...
local function computeUtilities(params,dbparams)
	...
	local cost_privatebus=cost_public_first+cost_public_second + cost_increase + cbd_dummy * AMOD_cost + cbd_dummy_origin *(1-cbd_dummy) * AMOD_cost
	...
	local cost_cardriver=cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second+cost_car_parking + cost_increase + cbd_dummy * AMOD_cost + cbd_dummy_origin *(1-cbd_dummy) * AMOD_cost
	local cost_carpassenger=cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second+cost_car_parking + cost_increase + cbd_dummy * AMOD_cost + cbd_dummy_origin *(1-cbd_dummy) * AMOD_cost
	local cost_motor=0.5*(cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second)+0.65*cost_car_parking + cost_increase + cbd_dummy * AMOD_cost + cbd_dummy_origin *(1-cbd_dummy) * AMOD_cost
