...
local beta_cons_bus = 0.95
local beta_cons_mrt = 0.3
local beta_cons_private_bus = -6 
local beta_cons_drive1 = 4
local beta_cons_share2 = -1
local beta_cons_share3 = -1.1
