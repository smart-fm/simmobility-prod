...
local beta_cons_bus = 3.407
local beta_cons_mrt = 2.463
local beta_cons_private_bus = -0.898
local beta_cons_drive1 = 0
local beta_cons_share2 = -0.449
local beta_cons_share3 = -0.533
local beta_cons_motor = 2.368
local beta_cons_walk = 3.379
local beta_cons_taxi = -9.508
