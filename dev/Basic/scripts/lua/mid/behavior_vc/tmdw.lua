...
local beta_log = 0.793              -- coefficient for derived variable log_area
local beta_area = 5.61              -- coefficient for area of destination zone
...
-------------------------------------------------
-- The variables having name format as  [ beta_<vehicleOwnerShipCategoryDummy>_<modeName> ]  are joint coefficients for vehicleOwnershipDummy variables and mode name
