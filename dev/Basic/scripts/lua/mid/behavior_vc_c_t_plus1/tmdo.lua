...
local function computeUtilities(params,dbparams)
	...
	for i =1,24 do
		...
		tt_SMS[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_rail_SMS[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])/6.0 + 1.0/60 -- Eytan added 1.0/60
