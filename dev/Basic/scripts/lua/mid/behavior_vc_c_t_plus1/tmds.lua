...
local function computeUtilities(params,dbparams)
	...
	for i =1,24 do
		...
		tt_bus[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+tt_public_out_first[i]+tt_public_out_second[i] + 1.0/60 -- Eytan added 1.0/60
		tt_mrt[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+tt_public_out_first[i]+tt_public_out_second[i] + 1.0/60 -- Eytan added 1.0/60
		tt_private_bus[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/60 -- Eytan added 1.0/60
		tt_drive1[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_share2[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_share3[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_motor[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_walk[i] = (d1[i]+d2[i])/5 + 1.0/60 -- Eytan added 1.0/60
		tt_taxi[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/6 + 1.0/60 -- Eytan added 1.0/60
		tt_SMS[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i] + 1.0/60 -- Eytan added 1.0/60
		tt_rail_SMS[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])*0.3 + 1.0/60 -- Eytan added 1.0/60
