...
local beta_cost_drive1_2_first = 0
local beta_cost_drive1_2_second = 0
...
local beta_tt_drive1_first = 0
local beta_tt_drive1_second = 0
local beta_tt_share2= 0
local beta_tt_share3= 0
local beta_tt_motor = 0
local beta_tt_walk = 0
local beta_tt_taxi_first = 0
local beta_tt_taxi_second = 0
local beta_tt_SMS_first = 0
local beta_tt_SMS_second = 0
