...
local beta_cons_taxi = -14.693
local beta_cons_SMS = -14.693
local beta_cons_rail_SMS = -2.705
...
local function computeUtilities(params,dbparams)
	...
	for i =1,24 do
		...
		cost_bus[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1.0 -- Eytan added 1.0
		cost_mrt[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1.0 -- Eytan added 1.0
		cost_private_bus[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + 1.0 -- Eytan added 1.0
		...
		--0 if origin == destination
		cost_drive1[i] = dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase + 1.0 -- Eytan added 1.0
		cost_share2[i] = (dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase)/2 + 1.0 -- Eytan added 1.0
		cost_share3[i] = (dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i)+dbparams:cost_car_parking(i)+cost_increase)/3 + 1.0 -- Eytan added 1.0
		cost_motor[i] = 0.5*(dbparams:cost_car_ERP_first(i)+dbparams:cost_car_ERP_second(i)+dbparams:cost_car_OP_first(i)+dbparams:cost_car_OP_second(i))+0.65*dbparams:cost_car_parking(i)+cost_increase + 1.0 -- Eytan added 1.0
		...
		cost_taxi[i] = cost_taxi_1[i] + cost_taxi_2[i] + cost_increase + 1.0 -- Eytan added 1.0
		...
		cost_SMS[i] = (cost_SMS_1[i] + cost_SMS_2[i])*0.6 + cost_increase + 1.0 -- Eytan added 1.0
		...
		cost_rail_SMS[i] = cost_public_first[i] + cost_public_second[i] + cost_increase + cost_Rail_SMS_AE_avg[i] * 2 * 0.6 + 1.0 -- Eytan added 1.0
		...
		tt_SMS[i] = tt_car_ivt_first[i] + tt_car_ivt_second[i]
		tt_rail_SMS[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])*0.3
