...
local function computeUtilities(params,dbparams)
	...
	local cost_bus=cost_public_first+cost_public_second+cost_increase +  1.0 -- Eytan added 1.0
	local cost_mrt=cost_public_first+cost_public_second+cost_increase +  1.0 -- Eytan added 1.0
	local cost_privatebus=cost_public_first+cost_public_second+cost_increase +  1.0 -- Eytan added 1.0
	...
	local cost_cardriver=cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second+cost_car_parking+cost_increase +  1.0 -- Eytan added 1.0
	local cost_carpassenger=cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second+cost_car_parking+cost_increase +  1.0 -- Eytan added 1.0
	local cost_motor=0.5*(cost_car_ERP_first+cost_car_ERP_second+cost_car_OP_first+cost_car_OP_second)+0.65*cost_car_parking+cost_increase +  1.0 -- Eytan added 1.0
	...
	local cost_taxi=cost_taxi_1+cost_taxi_2+cost_increase +  1.0 -- Eytan added 1.0
	...
	local cost_SMS=(cost_SMS_1+cost_SMS_2)*0.6 + cost_increase +  1.0 -- Eytan added 1.0
	...
	local cost_rail_SMS = cost_public_first + cost_public_second + cost_increase + (cost_Rail_SMS_AE_1 + cost_Rail_SMS_AE_2) * 0.6 +  1.0 -- Eytan added 1.0
