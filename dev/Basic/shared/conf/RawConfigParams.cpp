...
sim_mob::LongTermParams::LongTermParams(): enabled(false), workers(0), days(0), tickStep(0), maxIterations(0),year(0),simulationScenario(std::string()),resume(false),currentOutputSchema(std::string()),opSchemaloadingInterval(0){}
