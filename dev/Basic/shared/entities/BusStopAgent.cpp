...
void sim_mob::BusStopAgent::RegisterNewBusStopAgent(BusStop const & busstop, const MutexStrategy& mtxStrat, int id)
{
	//BusController* busctrller = new sim_mob::BusController(-1, mtxStrat);
	BusStopAgent * sig_ag = new BusStopAgent(busstop, mtxStrat, id);
