...
class RegionsAndPathEventArgs : public BaseCommsimEventArgs {
public:
	/**
	 ...
	 */
	RegionsAndPathEventArgs(const sim_mob::Agent* ag, const std::vector<sim_mob::RoadRunnerRegion>& allRegions, const std::vector<sim_mob::RoadRunnerRegion>& regionPath);
...
private:
	...
	std::vector<sim_mob::RoadRunnerRegion> allRegions;
	std::vector<sim_mob::RoadRunnerRegion> regionPath;
