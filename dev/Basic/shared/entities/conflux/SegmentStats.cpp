...
namespace sim_mob {
	...
	SegmentStats::SegmentStats(const sim_mob::RoadSegment* rdSeg)
		: roadSegment(rdSeg)
	{
	...
	std::pair<int, int> SegmentStats::getLaneAgentCounts(const sim_mob::Lane* lane) {
	...
	std::map<sim_mob::Lane*, std::pair<int, int> > SegmentStats::getAgentCountsOnLanes() {
