...
#define STATUS_LEFT_SIDE_OK "STATUS_LEFT_SIDE_OK"
#define STATUS_RIGHT_SIDE_OK "STATUS_RIGHT_SIDE_OK"
#define STATUS_CURRENT_LANE_OK "STATUS_CURRENT_LANE_OK"

#define DEFAULT_DISTANCE_CM 50000
