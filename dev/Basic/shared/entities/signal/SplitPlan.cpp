...
void SplitPlan::setChoiceSet(std::vector< vector<double> > choiceset){choiceSet = choiceset; NOF_Plans = choiceSet.size();}
const std::vector< vector<double> > &SplitPlan::getChoiceSet()const {return choiceSet;}
