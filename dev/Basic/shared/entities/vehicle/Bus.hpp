...
public:
	...
	: Vehicle(*clone), passengerCount(0), passengerCount_Old(0),busline(busLine), route(route), ptCheck(0,0), DistThreshold(2000), busCapacity(35),TimeOfBusreachingBusstop(0)
	{}
