...
public:
	...
	std::string& getTravleTimeTmpTableName() { return pathSetTravelTimeTmpTableName; }

	std::string& getTravleTimeRealtimeTableName() { return pathSetTravelTimeRealTimeTableName; }
