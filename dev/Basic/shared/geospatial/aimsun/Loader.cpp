...
//	void LoadPathSetDB(std::map<std::string,boost::shared_ptr<sim_mob::PathSet> > >& pool);
//	bool LoadPathSetDBwithId(std::map<std::string,boost::shared_ptr<sim_mob::PathSet> > >& pool,std::string& pathset_id);
