//This basically just includes everything you might need for the xmlLoader's implementation.
//  We should probably move it later, but for now too many things depend on it.
