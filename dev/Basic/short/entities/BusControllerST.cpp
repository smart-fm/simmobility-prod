...
void sim_mob::BusControllerST::handleRequest(sim_mob::DriverRequestParams rParams)
{
...
void sim_mob::BusControllerST::assignBusTripChainWithPerson(std::set<sim_mob::Entity*>& activeAgents)
{
