...
public:
    ...
    /**
      ...
      * @return void .
      */
	void settings(std::string ipadress, int port, int updateTime, std::string mapFile, int blockingTime) { this->ipAddress=ipadress; this->port=port; this->updateTime=updateTime; this->mapFile=mapFile; this->waitingSeconds=blockingTime;}
