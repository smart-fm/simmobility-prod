...
sim_mob::BusDriver::BusDriver(Person* parent, MutexStrategy mtxStrat, sim_mob::BusDriverBehavior* behavior, sim_mob::BusDriverMovement* movement) :
	Driver(parent, mtxStrat, behavior, movement), existed_Request_Mode(mtxStrat, 0), waiting_Time(mtxStrat, 0),
