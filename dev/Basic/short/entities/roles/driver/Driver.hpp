...
class Driver : public Role, public UpdateWrapper<DriverUpdateParams>
{
private:
	/**
...
public:
	...
	Driver(Person *parent, MutexStrategy mtxStrat, DriverBehavior *behavior = nullptr,
		   DriverMovement *movement = nullptr, Role::type roleType = RL_DRIVER, std::string roleName = "driver");
	virtual ~Driver();
