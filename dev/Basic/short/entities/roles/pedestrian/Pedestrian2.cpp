...
sim_mob::Pedestrian2::Pedestrian2(Agent* parent, sim_mob::Pedestrian2Behavior* behavior, sim_mob::Pedestrian2Movement* movement, std::string roleName):
		Role(behavior, movement, parent, roleName), params(parent->getGenerator()) {
