...
local beta_cost_AMOD_2 = -0.113
local beta_cost_Rail_AMOD_2 = -0.294
local beta_cost_AMOD_Pool_2 = -0.113
local beta_cost_Rail_AMOD_Pool_2 = -0.294
...
local beta_tt_AMOD = -3.33
local beta_tt_Rail_AMOD = -2.78
local beta_tt_AMOD_Pool = -3.33
local beta_tt_Rail_AMOD_Pool = -2.78
...
local beta_central_AMOD = 1.92
local beta_central_Rail_AMOD = -0.178
local beta_central_AMOD_Pool = 1.92
local beta_central_Rail_AMOD_Pool = -0.178
...
local beta_distance_Rail_AMOD = 0.00911
local beta_distance_AMOD_Pool =0
local beta_distance_Rail_AMOD_Pool = 0.00911

local beta_cons_bus = -1.885
local beta_cons_mrt = -2.705
local beta_cons_private_bus = -6.054
local beta_cons_drive1 = 0
local beta_cons_share2 = -5.843
local beta_cons_share3 = -6.578
local beta_cons_motor = -1.940
local beta_cons_walk = -2.525
local beta_cons_taxi = -15.193
local beta_cons_SMS = -15.258
local beta_cons_Rail_SMS = -3.900
local beta_cons_SMS_Pool = -19.940
local beta_cons_Rail_SMS_Pool = -11.110
local beta_cons_AMOD = -15.258
local beta_cons_Rail_AMOD = -3.900
local beta_cons_AMOD_Pool = -19.940
local beta_cons_Rail_AMOD_Pool = -11.110
...
local beta_oneplus_AMOD = -0.0655
...
local beta_oneplus_Rail_AMOD = 0.648
local beta_twoplus_Rail_AMOD = -2.55
local beta_threeplus_Rail_AMOD = 0
...
bundled_variables.beta_oneplus_AMOD_Pool = -0.0655
...
bundled_variables.beta_oneplus_Rail_SMS_Pool = 0.648
bundled_variables.beta_twoplus_Rail_SMS_Pool = -2.55
bundled_variables.beta_threeplus_Rail_SMS_Pool = 0

bundled_variables.beta_zero_Rail_AMOD_Pool = 0
bundled_variables.beta_oneplus_Rail_AMOD_Pool = 0.648
bundled_variables.beta_twoplus_Rail_AMOD_Pool = -2.55
bundled_variables.beta_threeplus_Rail_AMOD_Pool = 0

bundled_variables.beta_female_bus = 0.0894
bundled_variables.beta_female_mrt = 0
bundled_variables.beta_female_private_bus = -0.437
bundled_variables.beta_female_drive1 = 0
bundled_variables.beta_female_share2 = -0.669
bundled_variables.beta_female_share3 = -0.690
bundled_variables.beta_female_motor = -2.60
bundled_variables.beta_female_taxi = 0.404
bundled_variables.beta_female_SMS =  0.404
bundled_variables.beta_female_Rail_SMS = 0
bundled_variables.beta_female_walk = 1.83
bundled_variables.beta_female_SMS_Pool =  0.404
bundled_variables.beta_female_Rail_SMS_Pool = 0
bundled_variables.beta_female_AMOD =  0.404
bundled_variables.beta_female_Rail_AMOD = 0
bundled_variables.beta_female_AMOD_Pool =  0.404
bundled_variables.beta_female_Rail_AMOD_Pool = 0
...
local function computeUtilities(params,dbparams)
	...
	for i =1,1169 do
		...
		cost_Rail_AMOD_AE_avg[i] = (cost_Rail_AMOD_AE_1[i] + cost_Rail_AMOD_AE_2[i])/2.0
		...
		tt_Rail_AMOD[i] = tt_public_ivt_first[i]+ tt_public_ivt_second[i]+(tt_public_out_first[i]+tt_public_out_second[i])/6
