 ...
 * Schemas
 */
const std::string MAIN_SCHEMA = "synpop30.";
...
const std::string DB_TABLE_TAZ = APPLY_SCHEMA(DEMAND_SCHEMA, "taz_2030");
...
/**
 * Fields for long-term population database:synpop12_latest.table_individual_by_id_for_preday
 */
const std::string DB_FIELD_ID = "id";
const std::string DB_FIELD_INDIVIDUAL_ID = "individual_id";
...
const std::string DB_FIELD_VEHICLE_CATEGORY_NAME = "name";
	...
	/*
	 * synpop12_latest.postcode_amenities
	 */
...
/**
 * Fields for Zone data (in postgres db) demand.taz_2012
 */
...
/**
 * Fields for cost data (in postgres db) demand.learned_am_costs,pm_costs,op_costs
 */
...
/**
 * Fields for time dependent zone-zone travel times data (in postgres db) demand.learned_tcost_car,tcost_bus
 */
...
/**
 * Fields for node to zone mapping data (in postgres db) demand.node_taz_map
 */
