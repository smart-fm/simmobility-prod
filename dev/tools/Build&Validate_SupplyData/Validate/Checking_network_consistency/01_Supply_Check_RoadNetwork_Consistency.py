...
table_segment = 'supply2.segment'
table_lane = 'supply2.lane'
table_link = 'supply2.link'
table_tp = 'supply2.turning_path'
table_tg = 'supply2.turning_group'
table_connector = 'supply2.connector'
table_lanepoly = 'supply2.lane_polyline'
table_tppoly = 'supply2.turning_path_polyline'
...
def check_tp_tg(cursor):
    ...
    if wrong_tpspeed:
        print('\n Error! Wrong turning path speed. Please get the lowest speed between upstream and downstream segments.')
    ...
    if multi_tg_oneturning:
        print('\n Error! More than one turning group id in the single turning (One unique turning group between links).')
