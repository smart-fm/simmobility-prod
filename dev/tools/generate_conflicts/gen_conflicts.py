...
def main():
	...
	for conflict in conflicts :
	    cursor.execute('INSERT INTO "Turning_Conflict" (first_turning,second_turning,first_cd,second_cd) \
	      values (%s,%s,%s,%s)',\
		(conflict['first_turning'],conflict['second_turning'],conflict['first_cd'],conflict['second_cd']))
