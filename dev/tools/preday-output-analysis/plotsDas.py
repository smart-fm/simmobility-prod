...
outFolder = "/home/harish/simmobility/code_to_be_merged/dev/tools/preday-output-analysis/DAS_Check/output"
totalPopulation = 6000000
modeList = ['Car','Car Sharing 2','Car Sharing 3','MRT','BusTravel','Walk','SMS','SMS_Pool','Rail_SMS','PrivateBus','Taxi','Motorcycle','Bike','Rail_SMS_Pool']
stopList = ['Work','Education','Shop','Other','Home']
activityList = ['Work','Education','Shop','Other']
