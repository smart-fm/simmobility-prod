...
class Node:
  ...
  def __init__(self, nodeId, xPos, yPos):
    helper.assert_non_null("Null args", nodeId, xPos, yPos)
...
class Link:
  def __init__(self, linkId, fromNode, toNode):
    helper.assert_non_null("Null args", linkId, fromNode, toNode)
...
class Segment:
  def __init__(self, segId, fromNode, toNode):
    helper.assert_non_null("Null args", edgeId, fromNode, toNode)
...
class Lane:
  ...
  def __init__(self, laneId, laneNumber, parentSeg, polyline):
    helper.assert_non_null("Null args", laneId, laneNumber, parentSeg, polyline)
...
class LaneEdge:
  ...
  def __init__(self, laneEdgeNumber, parentSeg, polyline):
    helper.assert_non_null("Null args", laneEdgeNumber, parentSeg, polyline)
