...
class City:
    ...
    def generate_home_activities():
        for person in City.residents:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("Home", True, False, person.address, id)
    ...
    def generate_work_place_activities(companies):
        for company in companies:
            if len(company.staff):
                ...
                if key not in City.activities:
                    id = len(City.activities)
                    City.activities[key] = Activity("Work", True, False, company.address, id)
    ...
    def generate_shopping_activities():
        for shop in Registrar_of_companies.shops:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("Shopping", False, True, shop.address, id)
    ...
    def generate_school_activities():
        for school in Registrar_of_companies.schools:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("School", True, False, school.address, id)
    ...
    def generate_lunch_activities():
        for restuarant in Registrar_of_companies.restuarants:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("Lunch", False, True, restuarant.address, id)
    ...
    def generate_dinner_activities():
        for restuarant in Registrar_of_companies.restuarants:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("Dinner", False, True, restuarant.address, id)
    ...
    def generate_movie_activities():
        for movie_house in Registrar_of_companies.movie_houses:
            ...
            if key not in City.activities:
                id = len(City.activities)
                City.activities[key] = Activity("Movie", False, True, movie_house.address, id)
    ...
    def generate_trips():
        ...
        for person in City.residents:
            if person.father:
                ...
                if child.is_student:
                    generate_school_trips(child, City.trip_chains, City.activities)
            elif person.company:
                generate_work_trips(person, City.trip_chains, City.activities)

    @staticmethod
    def dump_sql_statements():
        City.dump_activity_spec_insert_statements()
        print >>sys.stderr
        City.dump_trip_chains_insert_statements()

    @staticmethod
    def dump_activity_spec_insert_statements():
        ...
        activities = City.activities.values()
    ...
    @staticmethod
    def dump_trip_chains_insert_statements():
